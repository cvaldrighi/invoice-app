    ...
    <div v-if="currentInvoice" class="invoice-view container">
        ...
        <div class="header flex">
            ...
            <div class="right flex">
                ...
                <button class="orange" v-if="currentInvoice.invoiceDraft || currentInvoice.invoicePaid"
                    @click="updateStatusToPending(currentInvoice.docId)">Mark as Pending</button>
            </div>
        ...
        <div class="invoice-details flex flex-column">
            ...
            <div class="bottom flex flex-column">
                <div class="billing-items">
                    ...
                    <div v-for="(item, index) in currentInvoice.invoiceItemList" class="item flex" :key="index">
                        <p>{{ item.itemName }}</p>
                        <p>{{ item.qty }}</p>
                        <p>${{ item.price }}</p>
                        <p>${{ item.total }}</p>
